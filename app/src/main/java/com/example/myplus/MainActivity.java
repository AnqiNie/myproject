...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.btn_0) {
            et_input.setText(str + "0");
        } else if (id == R.id.btn_1) {
            et_input.setText(str + "1");
        }
        else if (id == R.id.btn_2) {
            et_input.setText(str + "2");
        }
        else if (id == R.id.btn_3) {
            et_input.setText(str + "3");
        }
        else if (id == R.id.btn_4) {
            et_input.setText(str + "4");
        }
        else if (id == R.id.btn_5) {
            et_input.setText(str + "5");
        }
        else if (id == R.id.btn_6) {
            et_input.setText(str + "6");
        }
        else if (id == R.id.btn_7) {
            et_input.setText(str + "7");
        }
        else if (id == R.id.btn_8) {
            et_input.setText(str + "8");
        }
        else if (id == R.id.btn_9) {
            et_input.setText(str + "9");
